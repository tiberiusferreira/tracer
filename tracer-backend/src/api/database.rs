...
pub(crate) async fn insert_events(
    ...
    //     .collect();
    // let trace_ids: Vec<u64> = new_events.iter().map(|_s| trace_id).collect();
    //
    ...
    //         select * from unnest($1::UUID[], $2::BIGINT[], $3::BIGINT[], $4::timestamp[], $5::TEXT[], $6::severity_level[], $7::TEXT[], $8::TEXT[], $9::INT[]) returning id;",
    //         &instance_ids,
    //         &trace_ids,
    //         &span_ids,
    //         &timestamps,
    ...
    //         select * from unnest($1::UUID[], $2::BIGINT[], $3::BIGINT[], $4::BIGINT[], $5::TEXT[], $6::TEXT[]);",
    //         &kv_instance_id,
    //         &kv_trace_id,
    //         &kv_span_id,
    //         &kv_event_id,
