...
use tracer::player_api::EventRecordingPlayhead;
...
impl CurrentDatetimeIoRecorder {
    pub fn from_global_recording() -> Self {
        ...
        let io_events: Vec<tracer::player_api::SpecializedIoEvent<IoEvent>> = tracer::player_api::specialize_events_or_panic(io_events);
